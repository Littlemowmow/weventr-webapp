...
const places = [
  { id: 1, name: "La Boqueria Secret Stalls", location: "El Raval, Barcelona", description: "Skip the tourist-packed main aisles. Back stalls serve the best jamón ibérico and fresh seafood.", price: "$$", duration: "1-2h", rating: 9.2, tags: ["SideQuest", "Food"], image: "https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=600&h=400&fit=crop" },
  { id: 2, name: "Bunkers del Carmel", location: "El Carmel, Barcelona", description: "Panoramic sunset views over the entire city. Bring wine and snacks for the perfect evening.", price: "$", duration: "2-3h", rating: 9.5, tags: ["SideQuest", "Views"], image: "https://images.unsplash.com/photo-1583422409516-2895a77efded?w=600&h=400&fit=crop" },
  { id: 3, name: "Gothic Quarter Walk", location: "Barri Gòtic, Barcelona", description: "Wander through medieval streets, hidden squares, and discover ancient Roman walls.", price: "$", duration: "2h", rating: 9.2, tags: ["SideQuest", "Culture"], image: "https://images.unsplash.com/photo-1539037116277-4db20889f2d4?w=600&h=400&fit=crop" },
  { id: 4, name: "Park Güell Hidden Spots", location: "Gràcia, Barcelona", description: "Early morning visits reveal quiet corners and the best light for photos before crowds arrive.", price: "$$", duration: "2-3h", rating: 9.4, tags: ["SideQuest", "Nature"], image: "https://images.unsplash.com/photo-1583779457711-ab081de3e501?w=600&h=400&fit=crop" },
  { id: 5, name: "El Born Market", location: "El Born, Barcelona", description: "Ancient ruins beneath a modern food hall. History meets amazing tapas and local wine.", price: "$$$", duration: "1-2h", rating: 8.9, tags: ["SideQuest", "Food"], image: "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=600&h=400&fit=crop" },
  { id: 6, name: "Retiro Park Rowboats", location: "Madrid Centro", description: "Rent a rowboat on the crystal palace lake. Perfect afternoon escape from the city heat.", price: "$", duration: "1-2h", rating: 9.0, tags: ["SideQuest", "Nature"], image: "https://images.unsplash.com/photo-1543783207-ec64e4d95325?w=600&h=400&fit=crop" },
  { id: 7, name: "Sobrino de Botín", location: "Madrid", description: "World's oldest restaurant (1725). Order the roast suckling pig—it's legendary.", price: "$$$", duration: "2h", rating: 9.3, tags: ["Must Do", "Food"], image: "https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=600&h=400&fit=crop" },
  { id: 8, name: "Prado Museum Highlights", location: "Madrid", description: "Skip the full tour. Hit Velázquez, Goya, and Bosch. 90 minutes of pure art history.", price: "$$", duration: "1.5h", rating: 9.6, tags: ["Must Do", "Culture"], image: "https://images.unsplash.com/photo-1566127444979-b3d2b654e3d7?w=600&h=400&fit=crop" },
  { id: 9, name: "Malasaña Tapas Crawl", location: "Madrid", description: "Hipster neighborhood with the best vermouth bars. 3 stops, 3 hours, endless tapas.", price: "$$", duration: "3h", rating: 9.4, tags: ["SideQuest", "Food"], image: "https://images.unsplash.com/photo-1515443961218-a51367888e4b?w=600&h=400&fit=crop" },
  { id: 10, name: "Tram 28 Full Loop", location: "Alfama, Lisbon", description: "Historic yellow tram through Lisbon's steepest hills. Go early to avoid the crowds.", price: "$", duration: "45min", rating: 8.8, tags: ["Must Do", "Views"], image: "https://images.unsplash.com/photo-1585208798174-6cedd86e019a?w=600&h=400&fit=crop" },
  { id: 11, name: "LX Factory Sunset", location: "Alcântara, Lisbon", description: "Converted factory complex with street art, rooftop bars, and river views at golden hour.", price: "$$", duration: "2h", rating: 9.1, tags: ["SideQuest", "Views"], image: "https://images.unsplash.com/photo-1548707309-dcebeab426c8?w=600&h=400&fit=crop" },
  { id: 12, name: "Pastéis de Belém", location: "Belém, Lisbon", description: "The original custard tart recipe since 1837. There's a reason locals queue here daily.", price: "$", duration: "30min", rating: 9.7, tags: ["Must Do", "Food"], image: "https://images.unsplash.com/photo-1579888944880-d98341245702?w=600&h=400&fit=crop" },
]
